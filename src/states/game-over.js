...
(function (Tetris) {
    var GameOverState = (function (_super) {
        ...
        GameOverState.prototype.create = function (score, level) {
            ...
            this.addChild(new Kiwi.GameObjects.TextField(this, "Level", Tetris.Config.boardWidthInPixels / 2, 200, "#000", 24));
            this.addChild(new Kiwi.GameObjects.TextField(this, level.toString(), Tetris.Config.boardWidthInPixels / 2, 225, "#000", 24));
            this.addChild(new Kiwi.GameObjects.TextField(this, 'Play again', Tetris.Config.boardWidthInPixels / 2, 300, "#000", 24));
